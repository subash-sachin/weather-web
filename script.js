...
async function getdata(lat,lon){  
    let url1=`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&units=metric&appid=acc90535ce10461f497c5f60819c2806`;
...
async function search_val(){
    ...
    let url=`https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&APPID=acc90535ce10461f497c5f60819c2806`
    try{
        let res=await fetch(url)
        let data=await res.json()
